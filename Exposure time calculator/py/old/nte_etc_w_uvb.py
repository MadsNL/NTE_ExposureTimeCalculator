...
def read_nir_abs ():
    global nir_x, nir_y
    abs_data = np.loadtxt('data/NIR-abs2.dat')
...
def read_vis_dqe ():
    ...
    dqe_data = np.loadtxt('data/VIS_arm_DQE2.dat')
...
def read_ir_dqe ():
    ...
    dqe_data = np.loadtxt('data/IR_arm_DQE2.dat')
...
def read_uvb_dqe ():
    ...
    dqe_data = np.loadtxt('data/UVB_arm_DQE2.dat')
...
def read_luvb_tmp ():
    ...
    luvb_data = np.loadtxt('data/LUVB-ext2.dat')
    # extract wavelength (in um) and transmission of the atmosphere.
    luvb_x = luvb_data[:,0]
